...
```bash
npm test                        # suíte completa, modo offline (790 testes)
npm run test:supabase           # a mesma suíte, contra o banco real (791)
...
Os 790 são 778 passando, 3 pulados com motivo declarado e 9 `test.todo` (MEDIDO em
01/09/2026, na rodada da RF25). Os 33 que entraram com a RF25 (candidatura ao voluntariado)
...
na Action **e que ela NÃO chame `ehEquipe()`**; e a ordem das duas gravações. Os 35 que entraram
...
No modo `test:supabase` a contagem é 791, um a mais e dois pulados a mais (MEDIDO na rodada
da RF25: 777 passando, 5 pulados, 9 todo). O pulado novo é
...
Atualizado em 01/09/2026 (RF25 — a candidatura ao voluntariado; antes, no mesmo dia, a
RF11 — a área do usuário; o RF29,
